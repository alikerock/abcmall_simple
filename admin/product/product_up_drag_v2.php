        ...
        <table class="table table-bordered">
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="number" class="form-control text-right" name="delivery_fee" id="delivery_fee"></td>
                </tr>
                <tr>
                    <th scope="row" class="text-center align-middle">제품가격</th>
                    <td><input type="number" class="form-control text-right" name="price" id="price"></td>
                </tr>
                <tr>
                    <th scope="row" class="text-center align-middle">세일가격</th>
                    <td><input type="number" class="form-control text-right" name="sale_price" id="sale_price"></td>
                </tr>
                <tr>
                    <th scope="row" class="text-center align-middle">세일비율</th>
                    <td><input type="number" class="form-control text-right" name="sale_ratio" id="sale_ratio"></td>
                </tr>
                <tr>
                    <th scope="row" class="text-center align-middle">재고</th>
                    <td><input type="number" class="form-control text-right" name="cnt" id="cnt">
                    </td>
                </tr>
                <tr>
                    <th scope="row" class="text-center align-middle">전시옵션</th>
                    <td>
                        <input class="form-check-input" type="checkbox" name="ismain" value="1" id="ismain"><label
                            for="ismain">메인</label>
                        <input class="form-check-input" type="checkbox" name="isnew" value="1" id="isnew"><label
                            for="isnew">신제품</label>
                        <input class="form-check-input" type="checkbox" name="isbest" value="1" id="isbest"><label
                            for="isbest">베스트</label>
                        <input class="form-check-input" type="checkbox" name="isrecom" value="1" id="isrecom"><label
                            for="isrecom">추천</label>
                    </td>
                </tr>
                <tr>
...
<script>
    ...
    function preview(file, idx) {
        ...
        reader.onload = (function (f, idx) {
            return function (e) {
                var div = '<div class="thumb" id="' + idx + '"> \
        ...
        $.ajax({
            ...
            success: function (return_data) { //product_save_image.php 유무
                ...
                if (return_data.result == "member") {
                    ...
                    //let file = '/pdata/" + return_data.savename;
                    preview(file, return_data.imgid); //미리보기 만들기
                    // let imgid = $("#file_table_id").val() +  + ",";
