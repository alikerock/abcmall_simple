<?php 
    ...
    $sql = "SELECT * from products where ismain=1 and status=1";

    $order = " order by pid desc";//최근 등록 순으로 정렬
    $limit = " limit 0,6"; //0번째에서 6개까지  
                    ...
                    <div class="col-12 col-sm-6 col-md-4 single_gallery_item women wow fadeInUpBig"
                        ...
                        <div class="product-img">
                            ...
                            <div class="product-quicview">
                                <a href="product.php?pid=<?php echo $r->pid;?>" ><i class="ti-plus"></i></a>
                            </div>
                        </div>
                        <!-- Product Description -->
                        <div class="product-description">
                            <h4 class="product-price"><?php echo number_format($r->sale_price);?>원</h4>
                            <p><?php echo $r->name;?></p>
                            <!-- Add to Cart -->
